...
description: >
  ...
  solo developers using Codex — where the AI assistant has no memory
...
- After a Codex session produces code that contradicts a past decision
...
2. Read AGENTS.md (or equivalent spec file)
...
## Updating AGENTS.md to reference decisions
