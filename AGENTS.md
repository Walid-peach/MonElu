...
Read the [shared backlog conventions](.agents/skills/solve-issue/references/github-issues.md)
...
```ini
DATABASE_URL=postgresql://monelu:monelu@localhost:5432/monelu  # pragma: allowlist secret
